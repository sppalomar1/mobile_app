          ...
          <View style={styles.container}>
            <View style={styles.card}>
              ...
              <TouchableOpacity style={styles.imageBtn} onPress={pickImage}>
                <Text style={styles.imageBtnText}>{image ? "Change Image" : "Select Image"}</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.addBtn} onPress={handleAdd} disabled={uploading}>
                <Text style={styles.addBtnText}>{uploading ? "Uploading..." : "Add Menu Item"}</Text>
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: "#B37044" },
